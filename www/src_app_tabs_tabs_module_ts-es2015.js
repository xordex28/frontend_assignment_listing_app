...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'user',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_tabs_modules_user_user_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./modules/user/user.module */ 81002)).then(m => m.UserPageModule)
            }
        ]
    },
    {
...
TabsPage.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: TabsPage, selectors: [["app-tabs"]], decls: 10, vars: 0, consts: [["slot", "bottom"], ["tab", "tab1"], ["name", "triangle"], ["tab", "user"], ["name", "person-circle-outline"]], template: function TabsPage_Template(rf, ctx) { if (rf & 1) {
