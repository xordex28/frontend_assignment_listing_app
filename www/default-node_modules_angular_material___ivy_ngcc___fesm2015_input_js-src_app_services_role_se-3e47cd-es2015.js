...
class RoleService extends _utils_requests_api__WEBPACK_IMPORTED_MODULE_0__.API {
    constructor(http) {
        super(http);
        this.http = http;
        this.URL = `${this.URL_API}users/roles/`;
    }
...
//# sourceMappingURL=default-node_modules_angular_material___ivy_ngcc___fesm2015_input_js-src_app_services_role_se-3e47cd-es2015.js.map